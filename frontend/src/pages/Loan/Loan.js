...
const Loan = () => {
	...
	const calculateLoan = () => {
		...
		const paymentPerPeriod =
			(principal * ratePerPeriod * Math.pow(1 + ratePerPeriod, totalPayments)) /
		...
		<div
			...
			<div className="horizontal-cards">
				<section className="loan-section">
					...
					<p>
						A loan is a sum of money that is borrowed and is expected to be paid
						back with interest. Loans can be secured (backed by collateral) or
				...
				<section className="loan-section">
					...
					<p>
						...
						organization, or individual for a specific purpose, and it does not
						need to be paid back.
					</p>
					<a
						href="https://en.wikipedia.org/wiki/Grant_(law)"
						target="_blank"
						rel="noopener noreferrer">
						<button className="loan-button">Learn More</button>
					</a>
				...
				<section className="loan-section types-of-loans">
					...
					<a
						href="https://en.wikipedia.org/wiki/Loan#Types"
						target="_blank"
						rel="noopener noreferrer">
			...
			<section className="loan-calculator">
				...
				{calculationResult && (
					<div className="calculator-result">
						<h3>Loan Summary:</h3>
						<p>
							{calculationResult.frequency} Payment: $
							{calculationResult.paymentPerPeriod}
						</p>
